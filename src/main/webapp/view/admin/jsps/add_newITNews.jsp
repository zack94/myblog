...
<section class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
            <div class="row">
                <form action="<%=basePath%>addITNewsInfo.action" method="post" class="add-flink-form" autocomplete="off" draggable="false">
                    <div class="col-md-9">
                        <h1 class="page-header">增加IT新风向</h1>
                        <div class="add-article-box">
                            ...
                            <div class="add-article-box-content">
                                <input type="text" id="news_content" name="news_content" class="form-control"
                                       placeholder="在此处输入主要内容" required autofocus autocomplete="off">
                            </div>
                        </div>
                        <div class="add-article-box">
                            ...
                            <div class="add-article-box-content">
                                <input type="text" id="news_url" name="news_url" class="form-control"
                                       placeholder="在此处输入原文地址" required autocomplete="off">
                        ...
                        <div class="add-article-box">
                            ...
                            <div class="add-article-box-content">
                                ...
                                <p><label>&nbsp;&nbsp;&nbsp;target：</label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="news_way" value="_blank" checked/>_blank&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="news_way" value="_self"/>_self&nbsp;&nbsp;
